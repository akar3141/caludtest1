...
class TimeManager:
    ...
    def is_due(
        ...
        All comparison is performed in UTC, while target creation is done
        in the target market's real IANA timezone. This handles New York DST
        automatically and avoids hard-coded EST/EDT offsets.
        """
