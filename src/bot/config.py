...
class Settings(BaseSettings):
    ...
    # GitHub Actions scheduled workflows can be delayed substantially.
    # Python remains the final authority; once the target time has passed,
    # a later trigger on the same target date may still deliver the report.
